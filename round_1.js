var stations_1_json = '{ "stations" : ' +
'{"1" : {	"top" : 100,	"left" : 50,	"trophies" : 7	},' +
' "2" : {	"top" : 100,	"left" : 350,	"trophies" : 10	},' +
' "3" : {	"top" : 100,	"left" : 700,	"trophies" : 2	},' +
' "4" : {	"top" : 400,	"left" : 350,	"trophies" : 7	},' +
' "5" : {	"top" : 400,	"left" : 700,	"trophies" : 8	},' +
' "6" : {	"top" : 400,	"left" : 1100,	"trophies" : 6	}}	}';
var stations_1_data = JSON.parse(stations_1_json);

var direct_paths_1_json = '{ "paths" : ['+
' {"from":"1", "to":"2", "orientation":"horizontal" }, ' +
' {"from":"5", "to":"4", "orientation":"horizontal" }, ' +
' {"from":"5", "to":"6", "orientation":"horizontal" }, ' +
' {"from":"4", "to":"2", "orientation":"diagonal" }, ' +
' {"from":"2", "to":"3", "orientation":"horizontal" } ' +
' ] }';
var direct_paths_1 = JSON.parse(direct_paths_1_json);

var station_loop_time = 1;
var station_change_time = 0;
var paths_1_json = '{ "paths" : ['+
' {"from":"1", "to":"1", "shortest_path": [1], "time":' +station_loop_time+ ' }, ' +
' {"from":"1", "to":"5", "shortest_path": [1, 2, 4, 5], "time":' + (3+2*station_change_time) + ' }, ' +
...
' {"from":"1", "to":"6", "shortest_path": [1, 2, 4, 5, 6], "time":' + (4+3*station_change_time) + ' }, ' +
...
' {"from":"3", "to":"5", "shortest_path": [3, 2, 4, 5], "time":' + (3+2*station_change_time) + ' }, ' +
' {"from":"3", "to":"4", "shortest_path": [3, 2, 4], "time":' + (2+station_change_time) + ' }, ' +
' {"from":"3", "to":"2", "shortest_path": [3, 2], "time":1 }, ' +
' {"from":"3", "to":"3", "shortest_path": [3], "time":' +station_loop_time+ ' }, ' +
' {"from":"3", "to":"6", "shortest_path": [3, 2, 4, 5, 6], "time":' + (4+3*station_change_time) + ' }, ' +
' {"from":"4", "to":"1", "shortest_path": [4, 2, 1], "time":' + (2+station_change_time) + ' }, ' +
...
' {"from":"4", "to":"3", "shortest_path": [4, 2, 3], "time":' + (2+station_change_time) + ' }, ' +
' {"from":"4", "to":"6", "shortest_path": [4, 5, 6], "time":' + (2+station_change_time) + ' }, ' +
' {"from":"5", "to":"1", "shortest_path": [5, 4, 2, 1], "time":' + (3+2*station_change_time) + ' }, ' +
...
' {"from":"5", "to":"3", "shortest_path": [5, 4, 2, 3], "time":' + (3+2*station_change_time) + ' }, ' +
' {"from":"5", "to":"6", "shortest_path": [5, 6], "time":1 }, ' +
' {"from":"6", "to":"1", "shortest_path": [6, 5, 4, 2, 1], "time":' + (4+3*station_change_time) + ' }, ' +
